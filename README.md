...
Here's what's currently being worked on:
...
|-------|-------------|--------|
| **Eclipse** | A dark, sophisticated theme with deep blacks and accent highlights | 🔄 In Development |
| **Orion** | A sleek, modern theme featuring clean lines and vibrant color pops | 🔄 In Development |
| **Horizon** | A light, airy theme inspired by sunrise aesthetics | 🔄 In Development |
...
- **NovaChat** — Advanced chat enhancements
- **NovaNotifications** — Smart notification management
- **NovaUtilities** — Collection of quality-of-life tools

### Future Themes
- **Nebula** — Cosmic-inspired dark theme
- **Aurora** — Nature-themed vibrant palette
- **Eclipse Pro** — Enhanced version of Eclipse with more customization

### Future Systems
- **NovaDesignSystem** — Shared UI components and styling across all addons
- **NovaAPI** — Common APIs for plugin communication
- **NovaAssets** — Unified asset pipeline
...
```
NovaCreations-BetterDiscord/
├── plugins/              # BetterDiscord plugins (in development)
│   └── NovaCore/         # NovaCore plugin
├── themes/               # BetterDiscord themes (in development)
│   ├── Eclipse/          # Eclipse theme
│   ├── Orion/            # Orion theme
│   └── Horizon/          # Horizon theme
├── assets/               # Shared branding assets
├── previews/             # Screenshots and media (coming soon)
...
Here's the current development timeline:

- **Q2 2026**: NovaCore plugin release
- **Q3 2026**: Initial theme releases (Eclipse, Orion, Horizon)
- **Q4 2026**: NovaDesignSystem public release
- **2027**: New plugins and theme expansions
